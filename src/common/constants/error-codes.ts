...
export const ERROR_CODES = {
  ...
  // FARM ALERTS
  // ========================================
  FARM_ALERT_NOT_FOUND: 'FARM_ALERT_NOT_FOUND',
  FARM_ALERT_ALREADY_READ: 'FARM_ALERT_ALREADY_READ',
  FARM_ALERT_ALREADY_DISMISSED: 'FARM_ALERT_ALREADY_DISMISSED',
  FARM_ALERT_ALREADY_RESOLVED: 'FARM_ALERT_ALREADY_RESOLVED',
  FARM_ALERT_INVALID_STATUS_TRANSITION: 'FARM_ALERT_INVALID_STATUS_TRANSITION',
  FARM_ALERT_GENERATION_FAILED: 'FARM_ALERT_GENERATION_FAILED',
