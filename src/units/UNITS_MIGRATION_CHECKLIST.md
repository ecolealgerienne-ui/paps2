# Checklist de Remédiation - Units

> **Migration complète de l'entité Units**
>
> **Mode** : Big Bang (pas de backward compatibility)
>
> **Version API cible** : `/api/v1/units`
...
- [x] **Endpoint global** : `/api/v1/units`
- [N/A] **Endpoint farm-scoped** (pas applicable pour units)
...
- [x] **Audit Schema Prisma** : Tous les champs identifiés (16 champs)
- [x] **CreateDto** : Contient TOUS les champs créables
- [x] **UpdateDto** : Contient TOUS les champs modifiables (partial, exclut code et unitType)
...
✅ unitType (UnitType enum, required)
✅ description (String?, nullable)
✅ baseUnitCode (String?, nullable)
✅ conversionFactor (Float?, nullable)
...
| symbol | String | @IsNotEmpty | @IsOptional | string | Required |
...
| unitType | UnitType | @IsEnum | Excluded | UnitType | Not updatable |
| description | String? | @IsOptional | @IsOptional | string \| null | Nullable |
| baseUnitCode | String? | @IsOptional | @IsOptional | string \| null | Nullable |
| conversionFactor | Float? | @IsOptional | @IsOptional | number \| null | Nullable |
...
- [x] **Enum UnitType** utilisé (mass, volume, concentration, count, percentage, other)
- [x] Enum Prisma = Enum TypeScript
...
- [x] Recherche 6 champs (nameFr/En/Ar, code, symbol, description)
- [x] Tri sécurisé whitelist (7 champs)
- [x] Filtres: unitType, isActive
...
- [x] I18n documenté (13 clés)
- [x] Tests plan créé (70+ cas)
...
- ✅ Endpoint GET /type/:type pour filtrer par type
- ✅ Endpoint GET /code/:code pour accès direct par code
- ✅ Code auto-lowercase (normalisation)
- ✅ baseUnitCode auto-lowercase
- ✅ Enum UnitType complet
- ✅ Conversion logic testée
