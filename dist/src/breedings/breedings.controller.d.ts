...
export declare class BreedingsController {
    private readonly breedingsService;
    constructor(breedingsService: BreedingsService);
    create(farmId: string, dto: CreateBreedingDto): Promise<any>;
    findAll(farmId: string, query: QueryBreedingDto): Promise<any>;
    getUpcoming(farmId: string, days?: number): Promise<any>;
